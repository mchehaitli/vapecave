...
<div style="background:#f5f5f5;padding:18px 20px;border-radius:8px;margin:20px 0;font-size:14px;color:#333;">
  ...
  <div style="margin-top:6px;"><strong>Payment:</strong> ${data.paymentMethod === 'credit_card' ? 'Card Payment' : data.paymentMethod === 'cash' ? (isPickup ? 'Pay at Counter' : 'Cash on Delivery') : (isPickup ? 'Pay at Counter' : 'Cash on Delivery')}</div>
...
Payment: ${data.paymentMethod === 'credit_card' ? 'Card Payment' : data.paymentMethod === 'cash' ? 'Cash on Delivery' : 'Pay in Store'}
...
<div style="font-family: Arial, sans-serif; padding: 20px; max-width: 600px; background-color: #1a1a1a; color: #f5f5f5; border-radius: 10px;">
  <div style="background: linear-gradient(135deg, #ff7100, #ff9a00); padding: 20px; border-radius: 8px; margin-bottom: 20px;">
    ...
    <p style="margin: 5px 0 0; color: #1a1a1a; font-weight: bold;">Total: $${data.total} · ${data.paymentMethod === 'credit_card' ? 'Card Payment' : data.paymentMethod === 'cash' ? 'Cash' : 'Pay in Store'}</p>
  </div>
