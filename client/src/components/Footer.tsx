    ...
    <footer className="bg-card text-foreground border-t border-border">
      <div className="container mx-auto px-4 py-8">        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            <h4 className="font-['Poppins'] font-semibold text-lg mb-3">Connect With Us</h4>
            ...
            <p className="text-muted-foreground text-sm mb-4">Follow us for updates & promotions</p>
            
            {/* Quick Links */}
            <h4 className="font-['Poppins'] font-semibold text-lg mb-2">Quick Links</h4>
            <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm">
              ...
              <Link href="/faq"><span className="text-muted-foreground hover:text-primary transition-colors cursor-pointer">FAQs</span></Link>
            </div>
          </div>
          
          {/* Column 2: Main Contact */}
          <div>
            <h4 className="font-['Poppins'] font-semibold text-lg mb-3">Contact</h4>
            <ul className="space-y-2 text-sm">
              <li className="flex items-center">
                ...
                <a href="tel:+14692940061" className="text-muted-foreground hover:text-primary/80 transition-colors" onClick={() => (window as any).gtag?.('event', 'click_phone')}>(469) 294-0061</a>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-primary mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* Newsletter Signup */}
            <div className="mt-4">
              <h4 className="font-['Poppins'] font-semibold text-lg mb-2">Newsletter</h4>
              <p className="text-muted-foreground text-sm mb-2">Get deals & updates</p>
              
              {subscriptionSuccess && (
                <div className="bg-primary/20 border border-primary/40 text-white rounded p-2 mb-2 text-sm">
                  <i className="fas fa-check-circle text-primary mr-1"></i> Thanks for subscribing!
                </div>
              )}
              
              {subscriptionError && (
                <div className="bg-red-900/20 border border-red-500/40 text-white rounded p-2 mb-2 text-sm">
                  <i className="fas fa-exclamation-circle text-red-500 mr-1"></i> {subscriptionError}
                </div>
              )}
              ...
              <form onSubmit={handleSubscribe} className="flex">
                <input
                  ...
                  className="w-full px-3 py-1.5 text-sm bg-background text-foreground border border-border rounded-l-md focus:outline-none focus:ring-1 focus:ring-primary"
                  required
                />
                <button
                  type="submit"
                  className="bg-primary hover:bg-primary/90 text-black font-bold px-3 py-1.5 rounded-r-md transition-colors flex items-center justify-center disabled:opacity-70"
        ...
        <div className="mt-4 pt-3 text-center">
          <p className="text-xs text-muted-foreground/70">
            Proudly serving: Frisco (75033, 75034), The Rail District, Little Elm, The Colony, Hackberry, Plano, and Prosper. Your local vape shop near me.
          </p>
        </div>
      </div>
    </footer>
